...
import id.ac.unpas.ewaste.permintaan.PermintaanModelTable;
...
public class PermintaanCRUD
    ...
    private void buttonKirimActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_buttonKirimActionPerformed
        ...
        if (confirmation == JOptionPane.YES_OPTION) { //Jika Confirmation Option bernilai "Yes"
                ...
                id.ac.unpas.ewaste.penjemputan.PenjemputanCRUD penjemputanCRUD = new id.ac.unpas.ewaste.penjemputan.PenjemputanCRUD(
                    this.penjemputanDao);
                penjemputanCRUD.update(penjemputan);
                // lacak
                id.ac.unpas.ewaste.lacak.LacakCRUD lacakCRUD = new id.ac.unpas.ewaste.lacak.LacakCRUD(this.lacakDao);
